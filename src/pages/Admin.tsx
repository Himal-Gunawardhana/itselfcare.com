      ...
      <div className="space-y-8">
        ...
        <Card className="bg-card/50 backdrop-blur-sm border-border/50">
          <CardHeader>
            ...
            <CardDescription>
              Manage your website content with ease using the InnovateCare CMS
            </CardDescription>
          </CardHeader>
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center space-x-2">
                    <Badge variant="outline">✓</Badge>
                    <span className="text-sm">Section-based content management</span>
                  </div>
                  <div className="flex items-center space-x-2">
                    <Badge variant="outline">✓</Badge>
                    <span className="text-sm">Automatic content persistence</span>
                  </div>
                </div>
              </div>
              <div className="space-y-4">
